  ...
  return (
    <section className="features" id="features">
      ...
      <div className="features-list">
        ...
        <img src={`${process.env.PUBLIC_URL}/images/logo14.png`} alt=""  />
        ...
        <div className="feature">
        <img src={`${process.env.PUBLIC_URL}/images/logo16.png`} alt=""  />
          <h2>Clubs And <br /> Groups</h2>
          <p>Our membership management software provides full automation of membership renewals and payments.</p>
        </div>
      </div>
      <div className="info-section">
      <img src={`${process.env.PUBLIC_URL}/images/logo17.png`} alt=""   className="info-image"/>
